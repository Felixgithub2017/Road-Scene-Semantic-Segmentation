...
'''
Signature: tf.saved_model.loader.load(sess, tags, export_dir, **saver_kwargs)
Docstring:
...
File:      ~/miniconda3/envs/tensorflow_py36_huizeng/lib/python3.6/site-packages/tensorflow/python/saved_model/loader_impl.py
Type:      function
--------------------------------------------------------------------

Signature: tf.get_default_graph()
Docstring:
...
File:      ~/miniconda3/envs/tensorflow_py36_huizeng/lib/python3.6/site-packages/tensorflow/python/framework/ops.py
Type:      function
-------------------------------------------------------------------
'''
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    print('Training will be performed for {} epochs.'.format(epochs))
    print()
